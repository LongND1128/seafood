...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Seafood\Blog\Model\Blog::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('seafood_blog_blog');
            ...
            $this->dataPersistor->set('seafood_blog_blog', $data);
