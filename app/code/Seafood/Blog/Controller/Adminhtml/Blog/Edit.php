...
namespace Seafood\Blog\Controller\Adminhtml\Blog;

class Edit extends \Seafood\Blog\Controller\Adminhtml\Blog
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Seafood\Blog\Model\Blog::class);
        ...
        $this->_coreRegistry->register('seafood_blog_blog', $model);
