...
use Seafood\Blog\Api\Data\Post\PostInterfaceFactory;
use Seafood\Blog\Api\Data\Post\PostSearchResultsInterfaceFactory;
use Seafood\Blog\Api\PostRepositoryInterface;
use Seafood\Blog\Model\ResourceModel\Post as ResourcePost;
use Seafood\Blog\Model\ResourceModel\Blog\CollectionFactory as PostCollectionFactory;
...
class PostRepository implements PostRepositoryInterface
{
    ...
    public function delete(PostInterface $post)
    {
        try {
            ...
            $this->resource->load($postModel, $post->getBlogId());
